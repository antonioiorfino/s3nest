...
public class S3NestCreateBucketHandlerTest {
  ...
  /** Verifies that the CREATE_BUCKET handler delegates bucket creation to the storage port. */
  @Test
  void shouldCreateBucket() {
    ...
    S3NestCreateBucketHandler handler = new S3NestCreateBucketHandler(storage);
