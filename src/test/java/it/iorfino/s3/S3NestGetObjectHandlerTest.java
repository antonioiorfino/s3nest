...
public class S3NestGetObjectHandlerTest {
    ...
    /**
     * Verifies that the GET object handler returns the object retrieved from
     * the storage port.
     */
    @Test
    void shouldReturnObjectFromStorage() {
        ...
        S3NestS3ObjectResult objectResult =
    ...
    /**
     * Verifies that the GET object handler passes the bucket and object key
     * from the S3 request to the storage port.
     */
    @Test
    ...
    /**
     * Verifies that the GET object handler rejects a missing object returned
     * by the storage port.
     */
    @Test
    void shouldRejectMissingObject() {
        ...
        assertThrows(
                S3NestS3ObjectNotFoundException.class,
                () -> handler.handle(request)
        );
    }
