...
public class S3NestS3RequestRoutingTest {
    ...
    /**
     * Verifies that a parsed HTTP request can be routed to the handler
     * associated with the resulting S3 operation.
     */
    @Test
    ...
    /**
     * Verifies that a GET_OBJECT request is routed to the concrete GET object
     * handler.
     */
    @Test
    void shouldRouteGetObjectToGetObjectHandler() {
        AtomicReference<S3NestS3Object> retrievedObject =
                new AtomicReference<>();

        S3NestS3ObjectStorage storage = (bucket, objectKey) -> {
            S3NestS3Object object = new S3NestS3Object(
        ...
        S3NestGetObjectHandler handler =
                new S3NestGetObjectHandler(storage);
