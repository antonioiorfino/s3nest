...
public class S3NestDeleteBucketHandlerTest {
  ...
  /** Verifies that the DELETE_BUCKET handler delegates bucket deletion to the storage port. */
  @Test
  void shouldDeleteBucket() {
    ...
    S3NestDeleteBucketHandler handler = new S3NestDeleteBucketHandler(storage);
