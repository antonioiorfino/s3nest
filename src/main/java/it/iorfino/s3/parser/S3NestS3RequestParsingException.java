 ...
 *
 * <p>This exception represents a request-layer error, such as a malformed path, invalid query
 * parameters or an unsupported request structure.
 *
 * <p>The exception does not expose transport-specific or storage-specific implementation details.
 */
