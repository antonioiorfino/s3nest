 ...
 *
 * <p>The handler operates exclusively on the internal S3 request model and
 * produces an S3 operation result. It does not depend on HTTP transport
 * details or storage implementation details.</p>
 */
@FunctionalInterface
