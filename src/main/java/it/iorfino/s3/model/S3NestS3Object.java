 ...
 *
 * <p>The object contains its content stream and associated metadata. It is independent of both HTTP
 * transport and the concrete storage implementation.
 */
public final class S3NestS3Object {
   ...
   */
  public S3NestS3Object(InputStream body, Map<String, List<String>> metadata) {
    this.body = body;
