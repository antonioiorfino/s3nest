 ...
 *
 * <p>This class contains the semantic information required by S3 operation handlers without
 * exposing the underlying HTTP transport representation.
 *
 * <p>The request contains the identified S3 operation, optional bucket and object information,
 * query parameters, request headers and the request body.
 *
 * <p>This class does not perform request parsing, routing, authentication or storage access.
 */
public final class S3NestS3Request {
   ...
   * @param bucket the requested bucket name, or {@code null} when the request is not associated
   *     with a bucket
   * @param objectKey the requested object key, or {@code null} when the request is not associated
   *     with an object
