 ...
 *
 * <p>An {@code S3Operation} represents the semantic operation requested by
 * an HTTP request after its method, path and query parameters have been
 * interpreted by the request parser.</p>
 *
 * <p>This enum defines the initial S3 compatibility scope supported by
 * S3Nest. It is independent of HTTP transport details and storage
