 ...
 *
 * <p>The handler delegates object retrieval to the storage port and converts the stored object into
 * an S3 operation result.
 *
 * <p>The handler does not depend on HTTP transport details or on a concrete storage implementation.
 */
public final class S3NestGetObjectHandler implements S3NestS3OperationHandler {
  ...
  public S3NestS3OperationResult handle(S3NestS3Request request) {
    S3NestS3Object object = storage.getObject(request.bucket(), request.objectKey());
