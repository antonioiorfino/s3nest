 ...
 *
 * <p>The handler delegates bucket deletion to the bucket storage port and
 * returns an empty S3 operation result when the operation completes
 * successfully.</p>
 *
 * <p>The handler does not depend on HTTP transport details or on a concrete
 * storage implementation.</p>
 */
public final class S3NestDeleteBucketHandler
