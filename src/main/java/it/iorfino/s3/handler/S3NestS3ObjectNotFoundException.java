 ...
 *
 * <p>The exception belongs to the S3 application layer and does not depend
 * on HTTP transport or on a concrete storage implementation.</p>
 */
public final class S3NestS3ObjectNotFoundException extends RuntimeException {
     ...
     */
    public S3NestS3ObjectNotFoundException(
            String bucket,
            String objectKey) {
