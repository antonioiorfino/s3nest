 ...
 *
 * <p>The object content is exposed as a stream so that the result does not
 * require the entire object to be loaded into memory.</p>
 *
 * <p>Object metadata is represented separately from the object content and
 * remains independent of the HTTP transport layer.</p>
 */
public final class S3NestS3ObjectResult
